...
export function TableToolbar({
  ...
  const [isShowActive, setIsShowActive] = useState(() =>
    isNil(filters?.state?.showActive) ? 'true' : filters?.state?.showActive
  );
              ...
              {showActiveFilter && (
                <FormControl sx={{ minWidth: '150px' }}>
                  ...
                  <Select
                    ...
                    value={isShowActive}
                    onChange={(e) => {
                      setIsShowActive(e.target.value);
                      onFilterChange(e.target.value, 'showActive');
                    }}
                    displayEmpty
                  >
